...
public class AesUtils {
    ...
    public static String decryptAes(String encryptedText, String key, String iv) {
        try {
            ...
            Cipher cipher = Cipher.getInstance(MessageConstants.TRANSFORMATION, MessageConstants.BC);
            ...
            SecretKeySpec secretKeySpec = new SecretKeySpec(key.getBytes(StandardCharsets.UTF_8), MessageConstants.AES);
